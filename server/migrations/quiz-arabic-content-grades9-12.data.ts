/**
 * Arabic translations for Grade 9-12 quiz questions (all 6 UAE subjects).
 *
 ...
 * quiz-arabic-content-grades9-12.ts.
 */

export interface ArContent {
  // Match key: question text alone is not unique across the bank.
  question: string;
